...
(function () {
  ...
  // 초기화 및 이벤트 리스너 설정
  function initRAGApplication() {
    console.log('🚀 A-RAGApplication.js initRAGApplication 시작');
    ...
    console.log('✅ A-RAGApplication.js 초기화 완료');
  }

  // 페이지 로드 시 앱 초기화
  document.addEventListener('DOMContentLoaded', initRAGApplication);
})();
