...
3. 장애점 추론 1은 패턴 기반, 장애점 추론 2는 유사사례 기반으로 추론합니다.
"""
...
FIELD_KEYWORDS = {
    ...
    "전송": [
        ...
        "POTN", "MUT LOS", "Los of signal", "OSC LOS", "STM64 LOS", "AU AIS", "GFP FAIL", "MEP LSP LOC",
    ...
    "MW": [
        "MW", "M/W", "마이크로웨이브", "마이크로 웨이브", "MicroWave", "Micro Wave",
...
# 장애 증상 키워드
SYMPTOM_KEYWORDS = [
    "인터넷 끊김", "인터넷 서비스 불가", "끊김", "통화 불량", "서비스 장애", "먹통", "고장",
    "속도 저하", "지연", "지연 현상", "수시 장애", "CRC 에러", "인터넷 속도 저하", "불량", "문제", "오류", "에러",
    "접속 지연", "순단 현상", "순단", "절단", "피해", "단선", "단절", "통신 불량", "품질 저하"
]
